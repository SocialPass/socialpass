...
urlpatterns = [
    ...
    path(
        "<slug:team_slug>/events/update/<int:pk>/",
        views.EventUpdateView.as_view(),
        name="event_update",
    ),
    path(
        "<slug:team_slug>/events/tickets/<int:pk>/",
        views.EventTicketsView.as_view(),
        name="event_tickets",
    ),
    path(
        "<slug:team_slug>/events/go-live/<int:pk>/",
        views.EventGoLiveView.as_view(),
        name="event_go_live",
    ),
    path(
        "<slug:team_slug>/events/delete/<int:pk>/",
        views.EventDeleteView.as_view(),
        name="event_delete",
    ),
    path(
        "<slug:team_slug>/events/stats/<int:pk>/",
        views.EventStatsView.as_view(),
        name="event_stats",
    ),
    path(
        "<slug:team_slug>/events/tickets/<int:event_pk>/create/",
        views.TicketTierCreateView.as_view(),
        name="ticket_tier_create",
    ),
    path(
        "<slug:team_slug>/events/tickets/<int:event_pk>/create/nft/",
        views.TicketTierNFTCreateView.as_view(),
        name="ticket_tier_nft_create",
    ),
    path(
        "<slug:team_slug>/events/tickets/<int:event_pk>/create/fiat/",
        views.TicketTierFiatCreateView.as_view(),
        name="ticket_tier_fiat_create",
    ),
    path(
        "<slug:team_slug>/events/tickets/<int:event_pk>/create/free/",
        views.TicketTierFreeCreateView.as_view(),
        name="ticket_tier_free_create",
    ),
    path(
        "<slug:team_slug>/events/tickets/<int:event_pk>/update/<int:pk>",
        views.TicketTierUpdateView.as_view(),
        name="ticket_tier_update",
    ),
    path(
        "<slug:team_slug>/events/tickets/<int:event_pk>/delete/<int:pk>/",
        views.TicketTierDeleteView.as_view(),
        name="ticket_tier_delete",
    ),
    path(
        "<slug:team_slug>/events/rsvp-tickets/<int:event_pk>/",
        views.RSVPTicketsView.as_view(),
        name="rsvp_tickets",
    ),
    path(
        "<slug:team_slug>/events/rsvp-create-tickets/<int:event_pk>/",
        views.RSVPCreateTicketsView.as_view(),
        name="rsvp_create_tickets",
    ),
    path(
        "<slug:team_slug>/events/message-batches/<int:event_pk>/",
        views.MessageBatchesView.as_view(),
        name="message_batches",
    ),
    path(
        "<slug:team_slug>/events/message-batch-create/<int:event_pk>/",
