    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "expires",
                    models.DateTimeField(default=apps.root.models.BlockchainOwnership.set_expires),
                ),
            ],
            options={
                "abstract": False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "timezone",
                    models.CharField(max_length=30, null=True, verbose_name="time zone"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "members",
                    models.ManyToManyField(through="root.Membership", to=settings.AUTH_USER_MODEL),
                ),
                (
                    "pricing_rule_group",
                    models.ForeignKey(
        ...
        migrations.AddField(
            model_name="event",
            name="team",
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to="root.team"),
        ),
        migrations.AddField(
            model_name="event",
            name="user",
        ...
        migrations.AddField(
            ...
            name="event",
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="root.event"),
        ),
