...
TITLE_TEXT_COLOR = (228, 73, 121)       # Color of text titles
CONTENT_TEXT_COLOR = (0, 0, 0)          # Color of text content
BANNER_COLOR = (228, 73, 121)           # Background color of banners
...
BASE_FONT_TYPE = 'assets/fonts/Roboto-Bold.ttf'         # Default = Roboto
...
def generate_ticket(
    event_data, embed, top_banner_text='NFTY Labs Ticket', theme=None, 
