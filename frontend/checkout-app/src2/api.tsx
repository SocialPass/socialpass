...
export class TicketedEventRetrieve {
  ...
  static call = async ({ public_id }) => {
    // set url
    const url = `${getbaseUrl()}/checkout/v0/retrieve/${public_id}/`
    // set request options
...
export class TicketedEventRequestAccess {
  ...
  static call = async ({ public_id, checkout_type }) => {
    // set url
    const url = `${getbaseUrl()}/checkout/v0/request/${public_id}/?checkout_type=${checkout_type}`
...
export class TicketedEventGrantAccess {
  ...
  static call = async ({
    ...
    // setup url
    const url = `${getbaseUrl()}/checkout/v0/process/${public_id}/?checkout_type=${checkout_type}`
