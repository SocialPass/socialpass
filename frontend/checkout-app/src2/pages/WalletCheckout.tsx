			...
			<div className="row">
				...
				<div className="col-md-7">
					<div className="content">
						...
						<h6 className="text-strong fw-700 fsr-6 mt-30">
							Checkout Options
						</h6>
						<div className="alert rounded-3 border-secondary d-flex align-items-center" role="alert">
							...
							<div className="ms-20">
								...
								<p className="my-0">
									Select from the crypto wallet options.
								</p>
							</div>
						</div>
						<p className="d-flex align-items-start fs-base-n2">
							...
							<span>
								Proof of NFT ownership is <strong>not</strong> an NFT trade. We only need you to prove that you own the NFT to create the ticket.
							</span>
						</p>
						...
						<div className="row">
							...
							<div className="col-sm-4 pe-sm-10">
								<div className="wallet-button">
									<input type="radio" name="wallet" className="wallet-button-input" id="wallet-button-input-1" checked="checked" />
									<label for="wallet-button-input-1" className="wallet-button-label">
										<div className="ws-75 mw-100 mx-auto">
											<img src="https://raw.githubusercontent.com/WalletConnect/walletconnect-assets/492d95c038bbcde1517cab5fb90ed4514690e919/svg/circle/walletconnect-circle-blue.svg" className="img-fluid" alt="WalletConnect" />
										</div>
							...
							<div className="col-sm-4 pe-sm-10 pt-10 pt-sm-0">
								<div className="wallet-button">
									<input type="radio" name="wallet" className="wallet-button-input" id="wallet-button-input-2" />
									<label for="wallet-button-input-2" className="wallet-button-label">
										<div className="ws-75 mw-100 mx-auto">
											<img src="https://avatars.githubusercontent.com/u/18060234?s=280&v=4" className="img-fluid" alt="Coinbase" />
										</div>
										<div className="fs-base-n2 text-strong fw-700 text-truncate text-center mt-10">
											WalletLink
										</div>
							...
							<div className="col-sm-4 pe-sm-10 pt-10 pt-sm-0">
								<div className="wallet-button">
									<input type="radio" name="wallet" className="wallet-button-input" id="wallet-button-input-3" />
									<label for="wallet-button-input-3" className="wallet-button-label">
										<div className="ws-75 mw-100 mx-auto">
											<img src="https://upload.wikimedia.org/wikipedia/commons/3/36/MetaMask_Fox.svg" className="img-fluid" alt="Metamask" />
										</div>
										<div className="fs-base-n2 text-strong fw-700 text-truncate text-center mt-10">
											Metamask
										</div>
					...
					<div className="p-content position-md-sticky top-0 start-0">
						<div className="d-flex align-items-center">
							...
							<div className="text-secondary ms-auto">
								<a href="#" className="link-reset fw-bold">Edit</a>
							</div>
							{/* Edit button end */}
						</div>
						<p className="mt-10">
