...
export const TicketedEvent = (): JSX.Element => {
	...
	const { retrieveError, retrieveJson, grantAccessJson} = useContext(EventPortalContext);
				...
				<div className="col-md-7 mb-4 d-flex">
					<div className="col col-md-10">
						...
						<p className="d-flex align-items-center m-0 mt-1 mb-1">
							<img src={clock} height="16.9" width="16.9" className="me-1" alt="Date & Time"/>
							{retrieveJson.date} {retrieveJson.timezone}
						</p>
						<p className="d-flex align-items-center m-0 mt-1 mb-1">
							<img src={location} height="16.9" width="16.9" className="me-1" alt="Date & Time"/>
	...
	return <Loading loadingText="Fetching ticketed event..." />
}
