		...
		<>
			...
			<div className='mt-auto'>
				<div className='card text-base rounded-4 shadow-lg border-transparent'>
					<h1 className='fw-700 text-center fs-base-p6 mt-0'>
						Statistics &mdash; {event.title}
					</h1>
					...
					{isLoading ? (
						...
						<div className='text-center text-danger mb-20'>
							Error getting Statistics data
						</div>
					) : (
						<>
							<div className='row'>
